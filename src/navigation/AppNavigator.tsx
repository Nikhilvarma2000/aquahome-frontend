...
const AdminTabNavigator = () => {
  ...
  return (
    ...
    >
      ...
      <Tab.Screen name="CustomerManagement" component={CustomerManagement} options={{
        title: 'Customers',
        tabBarIcon: ({ color, size }) => <Feather name="users" size={size} color={color} />
      }} />
      <Tab.Screen name="OrderManagement" component={OrderManagement} options={{
        title: 'Orders',
      ...
      <Tab.Screen name="AdminProfile" component={ProfileScreen} options={{
        title: 'Profile',
...
const FranchiseTabNavigator = () => {
  ...
  return (
    ...
    >
      <Tab.Screen name="FranchiseDashboard" component={FranchiseDashboard} options={{
        title: 'Dashboard',
        tabBarIcon: ({ color, size }) => <Feather name="home" size={size} color={color} />
      }} />
      <Tab.Screen name="LocationManagement" component={LocationManagement} options={{
        title: 'Location',
        tabBarIcon: ({ color, size }) => <Feather name="map-pin" size={size} color={color} />
      }} />
      <Tab.Screen name="FranchiseOrders" component={OrderManagement} options={{
        title: 'Orders',
        tabBarIcon: ({ color, size }) => <Feather name="shopping-bag" size={size} color={color} />
      }} />
      <Tab.Screen name="FranchiseProfile" component={ProfileScreen} options={{
        title: 'Profile',
        tabBarIcon: ({ color, size }) => <Feather name="user" size={size} color={color} />
      }} />
    </Tab.Navigator>
...
const CustomerTabNavigator = () => {
  ...
  return (
    ...
    >
      <Tab.Screen name="CustomerDashboard" component={CustomerDashboard} options={{
        title: 'Home',
        tabBarIcon: ({ color, size }) => <Feather name="home" size={size} color={color} />
      }} />
      <Tab.Screen name="ProductListing" component={ProductListing} options={{
        title: 'Products',
        tabBarIcon: ({ color, size }) => <Feather name="shopping-cart" size={size} color={color} />
      }} />
      <Tab.Screen name="SubscriptionManagement" component={SubscriptionManagement as any} options={{
        title: 'Subscriptions',
        tabBarIcon: ({ color, size }) => <Feather name="calendar" size={size} color={color} />
      }} />
      <Tab.Screen name="CustomerProfile" component={ProfileScreen} options={{
        title: 'Profile',
        tabBarIcon: ({ color, size }) => <Feather name="user" size={size} color={color} />
      }} />
    </Tab.Navigator>
...
const ServiceAgentTabNavigator = () => {
  ...
  return (
    ...
    >
      <Tab.Screen name="ServiceAgentDashboard" component={ServiceAgentDashboard} options={{
        title: 'Dashboard',
        tabBarIcon: ({ color, size }) => <Feather name="home" size={size} color={color} />
      }} />
      <Tab.Screen name="TaskManagement" component={TaskManagement} options={{
        title: 'Tasks',
        tabBarIcon: ({ color, size }) => <Feather name="clipboard" size={size} color={color} />
      }} />
      <Tab.Screen name="ServiceLogs" component={ServiceLogs} options={{
        title: 'Service Logs',
        tabBarIcon: ({ color, size }) => <Feather name="file-text" size={size} color={color} />
      }} />
      <Tab.Screen name="AgentProfile" component={ProfileScreen} options={{
        title: 'Profile',
        tabBarIcon: ({ color, size }) => <Feather name="user" size={size} color={color} />
      }} />
    </Tab.Navigator>
...
const CustomerStackNavigator = () => {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="OrderPlacement" component={OrderPlacement} options={{ title: 'Place Order' }} />
      <Stack.Screen name="ServiceRequest" component={ServiceRequest} options={{ title: 'Request Service' }} />
...
const FranchiseStackNavigator = () => {
  ...
  return (
    ...
    >
      <Stack.Screen name="FranchiseTabs" component={FranchiseTabNavigator} options={{ headerShown: false }} />
      <Stack.Screen name="OrderDetails" component={OrderDetailsScreen} options={{ title: 'Order Details' }} />
    </Stack.Navigator>
  );
};
